...
commit_hash=$2
start_dir=$(pwd)
aws ecr get-login-password --profile $INFRASTRUCTURE_PROFILE --region us-east-1 | docker login --username AWS --password-stdin 585768141523.dkr.ecr.us-east-1.amazonaws.com
