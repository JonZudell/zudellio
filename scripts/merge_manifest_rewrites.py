...
def merge_manifest_rewrites():
    ...
    rewrites = load_json(os.path.join(os.path.dirname(__file__), '../interface/dist/rewrites.json'))['rewrites']
    ...
    with open(os.path.join(os.path.dirname(__file__), '../manifests/merged_manifest.json'), 'w') as f:
